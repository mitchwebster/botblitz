...
var file_pkg_common_proto_agent_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x99, 0x01, 0x0a, 0x03, 0x42, 0x6f, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x30, 0x0a, 0x14, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x5f, 0x72, 0x65, 0x70, 0x6f, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52,
	...
	,
}
...
var file_pkg_common_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_pkg_common_proto_agent_proto_goTypes = []interface{}{
	(Bet_Type)(0),             // 0: Bet.Type
	(*FantasyLandscape)(nil),  // 1: FantasyLandscape
	(*Bet)(nil),               // 2: Bet
	(*FantasySelections)(nil), // 3: FantasySelections
	(*FantasyTeam)(nil),       // 4: FantasyTeam
	(*LeagueSettings)(nil),    // 5: LeagueSettings
	(*PlayerSlot)(nil),        // 6: PlayerSlot
	(*Player)(nil),            // 7: Player
	(*Bot)(nil),               // 8: Bot
}
var file_pkg_common_proto_agent_proto_depIdxs = []int32{
	5, // 0: FantasyLandscape.settings:type_name -> LeagueSettings
	4, // 1: FantasyLandscape.bot_team:type_name -> FantasyTeam
	2, // 2: FantasyLandscape.bet:type_name -> Bet
	7, // 3: FantasyLandscape.players:type_name -> Player
	7, // 4: Bet.player:type_name -> Player
	0, // 5: Bet.type:type_name -> Bet.Type
	6, // 6: FantasySelections.slots:type_name -> PlayerSlot
	6, // 7: LeagueSettings.slots_per_team:type_name -> PlayerSlot
	1, // 8: AgentService.PerformFantasyActions:input_type -> FantasyLandscape
	3, // 9: AgentService.PerformFantasyActions:output_type -> FantasySelections
