clean:
	...
	rm -f py-grpc-server/agent_pb2.py
	rm -f py-grpc-server/agent_pb2.pyi
	rm -f py-grpc-server/agent_pb2_grpc.py

gen:
	protoc ./pkg/common/proto/agent.proto --go_out=./pkg/common/ --go-grpc_out=./pkg/common/
	cd py-grpc-server && python -m grpc_tools.protoc -I ../pkg/common/proto --python_out=. --pyi_out=. --grpc_python_out=. ../pkg/common/proto/agent.proto
