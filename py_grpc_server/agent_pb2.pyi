...
class GameState(_message.Message):
    __slots__ = ("players", "teams", "league_settings", "current_bot_team_id", "current_draft_pick", "current_fantasy_week")
    ...
    def __init__(self, players: _Optional[_Iterable[_Union[Player, _Mapping]]] = ..., teams: _Optional[_Iterable[_Union[FantasyTeam, _Mapping]]] = ..., league_settings: _Optional[_Union[LeagueSettings, _Mapping]] = ..., current_bot_team_id: _Optional[str] = ..., current_draft_pick: _Optional[int] = ..., current_fantasy_week: _Optional[int] = ...) -> None: ...
